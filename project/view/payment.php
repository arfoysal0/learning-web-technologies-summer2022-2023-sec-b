...
if (isset($_GET['patientId']) && isset($_GET['patientName']) && isset($_GET['doctorId']) && isset($_GET['doctorName']) && isset($_GET['date'])) {
...
<body>
    <h2>Payment</h2>
    <form align="center" method="post" action="../Controller/paymentaction.php" novalidate>
