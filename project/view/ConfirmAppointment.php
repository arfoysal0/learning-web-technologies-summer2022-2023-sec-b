...
<body>
    ...
    <form method="post" action="../Controller/ConfirmAppointmentAction.php" novalidate>
        <table align="center" style="border-collapse: collapse;"> 
            ...
            <tr>
                ...
                <td>
                    <input type="text" readonly placeholder="<?php echo $dname; ?>">
                    <input type="hidden" name="doctorname" value="<?php echo $dname; ?>">
                </td>
