...
<body>
	...
	<table align="center" width="40%" border="1" style="border-collapse: collapse;">
		<tr>
			...
			<th align="center">Cancel application</th>
		</tr>
	...
	if (mysqli_num_rows($result) > 0) {
	    while ($row = mysqli_fetch_assoc($result)) {
	        ...
	        <tr>
	        	...
	        	<td align="center">
	        		<button>
	        			<a href="../Controller/DeleteAppointment.php?appointmentId=<?php echo $appointmentId; ?>" style="text-decoration:none;">Cancel Appointment</a>
